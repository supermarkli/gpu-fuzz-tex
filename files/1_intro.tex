...
\begin{itemize}
    ...
    \item We demonstrate the effectiveness of \textsc{GPU-Fuzz} by uncovering 13 previously unknown bugs in major DL frameworks like PyTorch, TensorFlow, and PaddlePaddle.
\end{itemize}
